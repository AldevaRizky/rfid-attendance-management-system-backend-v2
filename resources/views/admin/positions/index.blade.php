            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-lg font-medium">Position List</h3>
                    </div>
                    <!-- Success Message -->
                    @if(session('success'))
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ Str::limit($position->description, 50) }}</td>
    ...
    <script>
        ...
        document.querySelectorAll('.edit-btn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                const positionLevel = this.getAttribute('data-level');

                document.getElementById('edit_name').value = positionName;
                document.getElementById('edit_description').value = positionDescription;
                document.getElementById('edit_level').value = positionLevel;
        ...
        @if($errors->any())
            ...
            @if(request()->isMethod('post'))
                const createModal = new bootstrap.Modal(document.getElementById('createPositionModal'));
                createModal.show();
